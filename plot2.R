...
png(filename = "plot2.png", width = 480, height = 480) #create a png device for the plot
par(bg=NA) #make background transparent like the example image
plot(x,dat$Global_active_power, type = "n", ylab = "Global Active Power (kilowatts)", xlab="") #create the plot without data
